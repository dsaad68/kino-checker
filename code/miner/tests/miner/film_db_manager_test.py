...
from integration_db.utils import str_2_date, str_2_datetime, str_2_time
...
def test_update_films_table(schemas, init_scripts):
    ...
    with IntegrationDb(schemas, init_scripts) as CONNECTION_STRING:
        ...
        assert (
            oppenheimer_film.image_url == "https://contentservice.cineorder.shop/contents/img?q=683jXD30IV9SmgAABHGWNjb"
        )  # type: ignore
