...
# %%
def test_get_upcommings_films_list(db_connection_uri_with_sample_data):
    # Prepare
    expected_films = [
        {"title": "Napoleon", "upcoming_film_id": 1},
    ...
    # Execute
    film_info_finder = FilmInfoFinder(db_connection_uri_with_sample_data)  # type: ignore
...
def test_get_showing_films_list(db_connection_uri_with_sample_data):
    # Prepare
    ...
    logger.info(showing_films_list)
...
def test_upsert_users(db_connection_uri_with_sample_data):
    # Prepare
    upsert = {"chat_id": "222211111", "message_id": "1111", "title": "Wish", "flags": "1,ov|0,imax|2,3d"}
    insert = {"chat_id": "555511111", "message_id": "2222", "title": "Wonka", "flags": "1,ov|1,imax|2,3d"}
...
def test_get_film_id_by_title(db_connection_uri_with_sample_data):
    # Execute
    film_info_finder = FilmInfoFinder(db_connection_uri_with_sample_data)  # type: ignore
...
def test_check_performance_version_availability(db_connection_uri_with_sample_data):
    # Execute
    film_info_finder = FilmInfoFinder(db_connection_uri_with_sample_data)  # type: ignore

    # Check if is_3d and is_imax set to 0 that means indifferent to imax
    is_marvel_3d = film_info_finder.check_performance_version_availability(
        "DCC63000012BHGWDVI", {"is_3d": True, "is_imax": 0}
    )
    # Check if is_ov and is_3d , and also is_imax set to 0 that means indifferent to imax
    is_marvel_3d_ov = film_info_finder.check_performance_version_availability(
        "DCC63000012BHGWDVI", {"is_3d": True, "is_ov": True, "is_imax": 0}
    )
    is_marvel_3d_ov_imax = film_info_finder.check_performance_version_availability(
        "DCC63000012BHGWDVI", {"is_3d": True, "is_ov": True, "is_imax": True}
    )

    # Check if is_ov and is_imax set to 0 that means indifferent to imax
    is_wonka_ov = film_info_finder.check_performance_version_availability(
        "A6D63000012BHGWDVI", {"is_ov": True, "is_imax": 0}
    )
    # Check if is_3d and is_imax set to 0 that means indifferent to imax
    is_wonka_3d = film_info_finder.check_performance_version_availability(
        "A6D63000012BHGWDVI", {"is_3d": True, "is_imax": 0}
    )
    is_wonka_imax = film_info_finder.check_performance_version_availability("A6D63000012BHGWDVI", {"is_imax": True})
    is_wonka_imax_ov = film_info_finder.check_performance_version_availability(
        "A6D63000012BHGWDVI", {"is_imax": True, "is_ov": True}
    )
    is_wonka_imax_3d = film_info_finder.check_performance_version_availability(
        "A6D63000012BHGWDVI", {"is_imax": True, "is_3d": True}
    )
...
def test_get_performance_ids_by_version(db_connection_uri_with_sample_data):
    # Prepare
    ...
    marvels_3d_ov = film_info_finder.get_performance_ids_by_version(
        "DCC63000012BHGWDVI", {"is_3d": True, "is_ov": True, "is_imax": 0}
    )
    marvels_3d_ov_imax = film_info_finder.get_performance_ids_by_version(
        "DCC63000012BHGWDVI", {"is_3d": True, "is_ov": True, "is_imax": True}
    )

    wonka_3d = film_info_finder.get_performance_ids_by_version("A6D63000012BHGWDVI", {"is_3d": True, "is_imax": 0})
    wonka_ov = film_info_finder.get_performance_ids_by_version(
        "A6D63000012BHGWDVI", {"is_ov": True, "is_imax": 0, "is_3d": 0}
    )
    wonka_imax = film_info_finder.get_performance_ids_by_version("A6D63000012BHGWDVI", {"is_imax": True})
    wonka_3d_imax = film_info_finder.get_performance_ids_by_version(
        "A6D63000012BHGWDVI", {"is_3d": True, "is_imax": True}
    )
    wonka_imax_ov = film_info_finder.get_performance_ids_by_version(
        "A6D63000012BHGWDVI", {"is_imax": True, "is_ov": True}
    )
...
def test_get_performance_dates_by_film_id(db_connection_uri_with_sample_data, date_ten_days_in_future_date):
    # Prepare
...
def test_get_performance_hours_by_film_id(db_connection_uri_with_sample_data, date_ten_days_in_future_date):
    # Prepare
    version_1 = {"is_imax": True}
    version_2 = {"is_ov": True}
    version_3 = {"is_imax": True, "is_ov": True}
    ...
    performance_hours_1 = film_info_finder.get_performance_hours_by_film_id(
        "A6D63000012BHGWDVI", version_1, date_ten_days_in_future_date
    )
    performance_hours_2 = film_info_finder.get_performance_hours_by_film_id(
        "A6D63000012BHGWDVI", version_2, date_ten_days_in_future_date
    )
    performance_hours_3 = film_info_finder.get_performance_hours_by_film_id(
        "A6D63000012BHGWDVI", version_3, date_ten_days_in_future_date
    )
